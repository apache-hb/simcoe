...
struct std::formatter<simcoe::math::Vec2<T>, CharT> : std::formatter<std::string_view, CharT> {
...
template<typename T, typename CharT>
struct std::formatter<simcoe::math::Vec3<T>, CharT> : std::formatter<std::string_view, CharT> {
...
template<typename T, typename CharT>
struct std::formatter<simcoe::math::Vec4<T>, CharT> : std::formatter<std::string_view, CharT> {
